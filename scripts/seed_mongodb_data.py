...
def seed_stocks(db):
    ...
    stocks_data = [
        ...
        {"id": 26, "stock_name": "팔로알토 네트웍스", "ticker": "PANW", "is_etf": False, "leverage_ticker": None, "use_leverage": True, "is_active": True, "created_at": "2025-12-02 12:31:24.228989+00", "updated_at": "2025-12-02 12:31:24.228989+00"},
